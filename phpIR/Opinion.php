...
class Opinion {
        private $index = array();
        private $classes = array('pos', 'neg', 'nuetral');
        private $classTokCounts = array('pos' => 0, 'neg' => 0, 'nuetral' => 0);
        private $tokCount = 0;
        private $classDocCounts = array('pos' => 0, 'neg' => 0, 'nuetral' => 0);
        private $docCount = 0;
        private $prior = array('pos' => 0.33, 'neg' => 0.33, 'nuetral' => 0.34);
        ...
        public function classify($document) {
                ...
                $this->prior['nuetral'] = $this->classDocCounts['nuetral'] / $this->docCount; 
